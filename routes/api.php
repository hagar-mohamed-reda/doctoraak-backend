...
Route::get('get-orders', 'Api\Patient\OrderController@getOrders');

Route::get('patient-buy-careiense', 'Api\Patient\AuthController@buyCarienseCard');
...
Route::get('pharmacy/get', 'Api\Patient\PatientPharmacyController@pharmacyFilter');
...
Route::get('show-cariense-details', 'Api\MainController@showCarienseDetails');
...
Route::get('help', 'Api\MainController@getHelpVideos');

Route::post('notification/remove', 'Api\MainController@removeNotification');
  
Route::get('show/pharmacy', 'Api\Patient\PatientPharmacyController@showPharmacy');
