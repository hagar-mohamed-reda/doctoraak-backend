...
class AuthController extends Controller
{
    ...
    /**
     * verfiy Radiology account with sms code
     *
     * @param Request $request
     * @return void
     */
    ...
    /**
     *  send new password in sms to Radiology phone
     *
     * @param Request $request
     * @return void
     */
    ...
    /**
     * update Radiology password based on sms password
     *
     * @param Request $request
     * @return void
     */
    ...
    public function update_profile(Request $request)
    {
        ...
        try {
            ...
            if ($insurances != null) {
             ...
             DB::statement("delete from radiology_working_hours where radiology_id='$user->id' ");
