@extends("layout.app", ["title" => __('insurances')])


@php
$builder = (new App\Insurance())->getViewBuilder();
@endphp
...
<div class="w3-padding" style="padding-bottom: 0px" >
    <ol class="breadcrumb shadow w3-round w3-white">
        ...
        <li class="active">{{ __('insurance') }}</li>
    </ol>
</div>
        ...
        <div class="box-body" >
            ...
            <div class="w3-row" >
                <div class="w3-col l3 m4 s6 w3-padding" > 
                    <label>{{ __('search with insurance info') }}</label>
...
<button class="btn btn-primary btn-flat modal-trigger"
        data-toggle="modal"
        data-target="#addModal"  >{{ __('add insurance') }}</button> 
@endsection
    ...
    <div class="modal-dialog modal-" role="document" >
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <center class="modal-title w3-xlarge">{{ __('add insurance') }}</center>
            </div>
...
<div class="modal fade"  role="dialog" id="editModal" style="width: 100%!important;height: 100%!important" >
    <div class="modal-dialog modal-" role="document" >
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <center class="modal-title w3-xlarge">{{ __('edit insurance') }}</center>
            </div>
...
<script>
    ...
    function search() {
        var url = "{{ url('/') }}/insurance/data?" + $.param(filter.filter);
