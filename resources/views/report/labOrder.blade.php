...
<form action="" method="get" >
    <div class="w3-row box card" style="width: 70%;margin: auto;padding: 10px" >
        <div class="box-title" >
            select lab orders between two dates
        </div>
        <div class="box-body" >
        ...
        <div class="box-footer" >
            ...
            <a href="{{ url('/report/laborder') }}" class="waves-effect waves-light btn w3-red">select all</a>
        </div>
    </div>
</form>
<br>
    ...
    <div class="w3-col l6 m6 s12 w3-padding" >
        <a class="info-box  w3-light-grey" href="laborder" >
            ...
            <div class="info-box-content">
                <span class="info-box-text">lab order</span>
