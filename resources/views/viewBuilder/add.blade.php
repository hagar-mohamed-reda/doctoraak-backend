    ...
    <div class="box-body row">
        ...
        <div class="form-group w3-padding {{ $col['col'] == null? 'col-lg-4 col-md-4 col-sm-6 col-xs-12' : $col['col'] }} ">
            ...
            <select
                ...
                onchange="$(this).parent().find('input[type=hidden]').val($('#{{ $col['id'] }}').val())"
                multiple="multiple"
                id="{{ $col['id'] }}"  >  
                @foreach($col["data"] as $data)
                <option 
        ...
        <div class="form-group w3-padding {{ $col['col'] == null? 'col-lg-4 col-md-4 col-sm-6 col-xs-12' : $col['col'] }} "   >
            ...
            <p class="w3-tiny w3-text-gray" id="latLngPlace{{$col['label']}}" ></p>
            <br>
            ...
            <script>
                ...
                function initMap() {
                    ...
                    placeMarker = function (position, map) {
                        ...
                        map.panTo(position);
                        //
                        $('#latLngPlace{{$col['label']}}').html(position.lat()+"-"+position.lat());
                    }
