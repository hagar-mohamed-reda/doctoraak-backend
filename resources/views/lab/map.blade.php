@extends("layout.app", ["title" => __('labs')])
...
<div class="w3-padding" style="padding-bottom: 0px" >
    <ol class="breadcrumb shadow w3-round w3-white">
        ...
        <li><a href="#" onclick="showPage('lab')" >{{ __('lab') }}</a></li> 
        <li class="active">{{  __('lab locations') }}</li>
    </ol>
</div>
@endsection
...
<script>
    ...
    function filterResult() { 
        showPage('lab/map?' + $.param(filter.filter));       
    }
    ...
    filter = new Vue({
        ...
        data: {
            filter: {
                ...
                lab_doctor_id: '{{ request()->lab_doctor_id }}',
    ...
    $(document).ready(function(){
        ...
        $('.lab_doctor_id').val('{{ request()->lab_doctor_id }}');
