        ...
        <div class="w3-padding info-box-container" style="height: 120px" > 
            ...
            <div class="z-depth-1 w3-round w3-white w3-display-container card info-box w3-animate-left transition" >
                ...
                <div class="hover-info hover w3-padding" > 
                    ...
                    <b class="w3-xlarge w3-text-white" >{{ ($lang=="en")? "lab reservation" : 'حجزات المعمل'  }}</b>
                    <br>
                    <span class="w3-xxxlarge w3-text-white" >{{ $lab->orders()->count() }}</span>
            ...
            <div class="z-depth-1 w3-round w3-white w3-display-container card info-box w3-animate-left transition" >
                ...
                <div class="hover-info hover w3-padding" > 
                    ...
                    <br>
                    <span class="w3-xxxlarge w3-text-white" >{{ $lab->working_hours()->where('active', '1')->count() }}</span>
            ...
            <div class="z-depth-1 w3-round w3-white w3-display-container card info-box w3-animate-left transition" >
                ...
                <div class="hover-info hover w3-padding" > 
                    ...
                    <b class="w3-large w3-text-white" >{{ ($lang=="en")? "analysis number" : "عدد التحاليل المتاحه " }}</b>
                    <br>
                    <span class="w3-xxxlarge w3-text-white" >{{ App\Analysis::count() }}</span>
            ...
            <div class="z-depth-1 w3-round w3-white w3-display-container card info-box w3-animate-left transition" >
                ...
                <div class="hover-info hover w3-padding" > 
                    ...
                    <br>
                    <span class="w3-xxxlarge w3-text-white" >{{ $lab->lab_insurances()->count() }}</span>
    ...
    <script>
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: '{{ $lang == "en"? "reservation of lab per day" : "حجزات المعمل فى اليوم"  }}',
                    data: [
                    @foreach($lab->getChartData() as $key => $value)
                    {{ $value }},
                    @endforeach
