<?php
    ...
    $pharmacy = App\Pharmacy::find($_GET["pharmacy"]);
        ...
        <div class="w3-padding info-box-container" style="height: 120px" >
            ...
            <div class="z-depth-1 w3-round w3-white w3-display-container card info-box w3-animate-left transition" >
                ...
                <div class="hover-info hover w3-padding" >
                    ...
                    <b class="w3-xlarge w3-text-white" >{{ ($lang=="en")? "pharmacy orders" : 'طلبات الصيدليه'  }}</b>
                    <br>
                    <span class="w3-xxxlarge w3-text-white" >{{ $pharmacy->orders()->count() }}</span>
            ...
            <div class="z-depth-1 w3-round w3-white w3-display-container card info-box w3-animate-left transition" >
                ...
                <div class="hover-info hover w3-padding" >
                    ...
                    <br>
                    <span class="w3-xxxlarge w3-text-white" >{{ $pharmacy->working_hours()->where('active', '1')->count() }}</span>
            ...
            <div class="z-depth-1 w3-round w3-white w3-display-container card info-box w3-animate-left transition" >
                ...
                <div class="hover-info hover w3-padding" >
                    ...
                    <br>
                    <span class="w3-xxxlarge w3-text-white" >{{ $pharmacy->pharmacy_insurances()->count() }}</span>
    ...
    <script>
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: '{{ $lang == "en"? "orders of pharmacy per day" : "طلبات الصيدليه فى اليوم"  }}',
                    data: [
                    @foreach($pharmacy->getChartData() as $key => $value)
                    {{ $value }},
                    @endforeach
