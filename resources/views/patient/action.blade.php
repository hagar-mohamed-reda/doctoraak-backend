        ...
        <div class="modal-content w3-light-gray">
            ...
            <div class="modal-body">
                <ul class="w3-ul" >
                    ...
                    <li class="w3-padding cursor hidden"  onclick="showPage('laborder/create?api_token={{ $patient->api_token }}&patient_id=' + '{{ $patient->id }}')"  >
                        <div class="w3-round w3-white w3-border-gray w3-border" >
                    ...
                    <li class="w3-padding cursor hidden"  onclick="showPage('radiologyorder/create?api_token={{ $patient->api_token }}&patient_id=' + '{{ $patient->id }}')"  >
                        <div class="w3-round w3-white w3-border-gray w3-border" >
